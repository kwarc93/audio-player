...
#define FF_USE_BUFF_WO_ALIGNMENT  1
...
/  must be set to 1 to align data into 32bits through an internal scratch buffer
/  before being processed by the DMA . Otherwise (DMA not used), this define must
/  be set to 0 to avoid Data alignment and improve the performance.
/  Please note that if _USE_BUFF_WO_ALIGNMENT is set to 0 and an unaligned 32bits
