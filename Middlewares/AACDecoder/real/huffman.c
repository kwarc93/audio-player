 ...
 *                  (since count[nBits] = 0)
 **************************************************************************************/
/*__attribute__ ((section (".data.ramfunc")))*/ int DecodeHuffmanScalar(const signed short *huffTab, const HuffInfo *huffTabInfo, unsigned int bitBuf, signed int *val)
{
 ...
 *                are a multiple of 4 coefficients long
 **************************************************************************************/
/*__attribute__ ((section (".data.ramfunc")))*/ static void UnpackQuads(BitStreamInfo *bsi, int cb, int nVals, int *coef)
{
 ...
 *                are a multiple of 4 coefficients long
 **************************************************************************************/
/*__attribute__ ((section (".data.ramfunc")))*/ static void UnpackPairsNoEsc(BitStreamInfo *bsi, int cb, int nVals, int *coef)
{
 ...
 *                are a multiple of 4 coefficients long
 **************************************************************************************/
/*__attribute__ ((section (".data.ramfunc")))*/ static void UnpackPairsEsc(BitStreamInfo *bsi, int cb, int nVals, int *coef)
{
 ...
 **************************************************************************************/
/*__attribute__ ((section (".data.ramfunc")))*/ void DecodeSpectrumLong(PSInfoBase *psi, BitStreamInfo *bsi, int ch)
{
 ...
 **************************************************************************************/
/*__attribute__ ((section (".data.ramfunc")))*/ void DecodeSpectrumShort(PSInfoBase *psi, BitStreamInfo *bsi, int ch)
{
